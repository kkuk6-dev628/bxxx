...
public class UserSaveListActivity extends AppCompatActivity implements DialogInterface.OnCancelListener{
    private static String TAG = UserSaveListActivity.class.getSimpleName();

    private Context mContext;
    AnimatedActivity pActivity;
    private Resources res;
    private ListView lstSaveHistory;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pActivity = (AnimatedActivity) UserSaveListActivity.this.getParent();
        ...
        lytBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(UserSaveListActivity.this, MeActivity.class);
    ...
    private void getPapers() {
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                final ProgressHUD progressDialog = ProgressHUD.show(mContext, res.getString(R.string.processing), true, false, UserSaveListActivity.this);
            ...
            try {
                ...
                lyt_home_favor.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent intent = new Intent(UserSaveListActivity.this, RoomDetailActivity.class);
    ...
    private void delPapers() {
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                for(int i=0;i<lyt_history_parent.getChildCount();i++){
                    CheckBox chk = (CheckBox)lyt_history_parent.getChildAt(i).findViewById(R.id.img_select);
                    System.out.println("ppp+"+chk.isChecked());
