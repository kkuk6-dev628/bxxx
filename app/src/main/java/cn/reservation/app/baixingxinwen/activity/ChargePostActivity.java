...
public class ChargePostActivity extends AppCompatActivity implements DialogInterface.OnCancelListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CommonUtils.customActionBar(mContext, this, true, "购买发布条数");
            ...
            switch (msg.what) {
                case SDK_PAY_FLAG: {
                    ...
                    if (TextUtils.equals(resultStatus, "9000")) {
                        ...
                        Toast.makeText(ChargePostActivity.this, "支付成功", Toast.LENGTH_SHORT).show();
                        switch(fId){
                            case "2":
                                postData1();
                                break;
                        ...
                        Toast.makeText(ChargePostActivity.this, "支付失败", Toast.LENGTH_SHORT).show();
                    }
                    break;
                }
                /*
