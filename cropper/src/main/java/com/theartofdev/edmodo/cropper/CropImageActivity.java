...
public class CropImageActivity extends AppCompatActivity
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    ...
    System.out.println("222"+R.id.crop_image_menu_crop);
  ...
  protected void onActivityResult(int requestCode, int resultCode, Intent data) {
    System.out.println("qqq++"+requestCode);
  ...
  public void onCropImageComplete(CropImageView view, CropImageView.CropResult result) {
    ...
    editor.putString("crop", result.getUri().toString());
    editor.apply();
  }
  ...
  protected void cropImage() {
    System.out.println("okokokok11"+mOptions.noOutputImage);
    if (mOptions.noOutputImage) {
      setResult(null, null, 1);
    } else {
        System.out.println("okokokok222");
      Uri outputUri = getOutputUri();
        System.out.println("okokokok222"+outputUri);
  ...
  protected Intent getResultIntent(Uri uri, Exception error, int sampleSize) {
    CropImage.ActivityResult result =
        new CropImage.ActivityResult(
            ...
            sampleSize);
    System.out.println("intent"+uri.getEncodedPath());
